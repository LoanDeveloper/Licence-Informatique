...
INSERT INTO `categorie` VALUES (1,'téléphonie','téléphones'),(2,'bureautique','chaise, clavier, souris, imprimantes ...'),(3,'photographie','L’appareil photo reste le meilleur moyen de saisir les moments heureux de sa vie personnelle ou d’immortaliser ses souvenirs de voyage.');
...
CREATE TABLE `commentaire` (
  ...
  `texte` varchar(1500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `commentaire` VALUES (1,2,'Cet iPhone vient remplacé mon iPhone 12 mini. Après quelques jours d’utilisation, je le trouve plus réactif. Le transfert de données entre les 2 appareils est d’une grande simplicité. Le design est au top. La batterie tient une journée entière. Pour le moment, je n’ai pas d’avis négatif. Mis à part le prix, cet iPhone 14 est une réussîte.',4.5,'2023-04-21','Très bon smartphone'),(2,2,'Deçu ! La batterie ne tient plus après 2 semaines d\'utilisations !',2.2,'2023-04-21','Deçu !'),(6,3,'La qualité d\'impression est parfaite, le prix est plutôt abordable. Je recommande !',4.7,'2023-04-21','Parfait');
...
INSERT INTO `produit` VALUES (2,'Iphone 14','APPLE iPhone 14 128GB Starlight',850,'iphone-14.jpg',1),(3,'Imprimante','CANON Imprimante PIXMA TS3450 Multifonction - WiFi',60,'imprimante.jpeg',2),(4,'Pixel 7','GOOGLE Pixel 7 - 128 Go - Noir',600,'pixel7.jpg',1),(5,'pixel2','pixel2',78,'pixel2.jpeg',1),(6,'Appareil Photo','Appareils Photo numériques 4K pour la Photographie, Appareil Photo Vlogging 48 MP pour Youtube avec écran pivotant à 180°',200,'appareil_photo.jpg',3);
...
INSERT INTO `tag` VALUES (1,'iphone'),(2,'canon'),(3,'bleu'),(4,'reflex');
...
INSERT INTO `tag_produit` VALUES (1,2),(2,3),(3,2),(4,3);
...
-- Dump completed on 2023-04-21 19:03:16
